...
class IssuesForm(ModelForm):
     ...
     class Meta:
         model = issues
         fields = ['level_issue', 'current_status', 'brief_description', 'start_down_date', 'start_down_time', 'start_issue_date', 'start_issue_time', 'workspace',  'creator', 'groups_of_work', 'coordinator', 'executor', 'progress', 'group_of_reason', 'solution', 'comment']
     ...
     def __init__(self, *args, **kwargs):
         ...
         self.fields['executor'].initial = User.objects.get(pk=6)
